...
public class PcAccountLogExtendApiAction implements PcAccountLogExtendApi {
	 ...
	 *            1.最近两天,2.两天到三个月
	 * @param startDate
	 *            开始时间(当history_type是2时,填写)
	 * @param endDate
	 *            结束时间 (当history_type是2时,填写)
	 * @param pageNo
	 *            当前页
	 * @param pageSize
	 *            页大小
