...
public enum IdTypeEnum {
    ...
    //bb
    BB_TX_ID(20),
    BB_ACCOUNT_LOG_ID(21),
    BB_ACCOUNT_RECORD_ID(22),
    BB_ORDER_ID(23),
    BB_ORDER_LOG_ID(24),
    BB_ORDER_TRADE_ID(25),
    BB_ACTIVE_ORDER_ID(26),
    BB_MATCHED_TRADE_ID(27),
    BB_COLLECTOR_ACCOUNT_ID(28),
    BB_COLLECTOR_ACCOUNTRECORD_TRADE_ID(29),
