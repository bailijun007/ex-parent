...
public enum IdTypeEnum {
    ...
    BB_ORDER_ID(22),
    BB_ORDER_HISTORY_ID(23),
    BB_ACTIVE_ORDER_ID(24),
    BB_MATCHED_TRADE_ID(25),
    BB_COLLECTOR_ACCOUNT_RECORD_ID(26),
    BB_ACCOUNT_LOG_ID(27),
//  BB_ORDER_TRADE_ID(28),
    ...
    PC_LIQ_RECORD_ID(35),
    PC_ORDER_ID(36),
    PC_ORDER_HISTORY_ID(37),
    PC_POSITION_ID(38),
    PC_POSITION_HISTORY_ID(39), 
//  PC_ORDER_TRADE_ID(38),
    
    PC_COLLECTOR_ACCOUNT_RECORD_ID(40),
