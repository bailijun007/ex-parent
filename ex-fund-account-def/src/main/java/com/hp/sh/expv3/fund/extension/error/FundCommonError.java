...
public class FundCommonError extends ErrorCode {
    ...
    public static final DepositExtError ORDER_CALLBACK_NOTIFY_FIND_SIGN_ERROR = new DepositExtError(10503, "订单成功回调通知签名不对");
    public static final DepositExtError ORDER_CALLBACK_NOTIFY_FAIL = new DepositExtError(10504, "订单回调通知失败");
