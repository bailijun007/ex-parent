...
@Service("threadManagerPcMatchImpl")
public class ThreadManagerMatchImpl implements IThreadManager, ApplicationContextAware {
    ...
    public synchronized IThreadWorker addWorker(String assetSymbol, ITask initTask) {
        ...
        ThreadWorkerMatchImpl worker = this.applicationContext.getBean(ThreadWorkerMatchImpl.class, this);
