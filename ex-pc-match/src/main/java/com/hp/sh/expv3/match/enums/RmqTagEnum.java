...
public enum RmqTagEnum implements EnumDescribe {
    ...
    PC_POS_MARGIN_NOT_ENOUGH(EventEnum.PC_POS_MARGIN_NOT_ENOUGH.getCode(), EventEnum.PC_POS_MARGIN_NOT_ENOUGH.getConstant()),
    ...
    PC_SAME_SIDE_ORDER_CANCELLED(EventEnum.PC_SAME_SIDE_ORDER_CANCELLED.getCode(), EventEnum.PC_SAME_SIDE_ORDER_CANCELLED.getConstant()),

    PC_SAME_SIDE_ORDER_ALL_CANCELLED(EventEnum.PC_SAME_SIDE_ORDER_ALL_CANCELLED.getCode(), EventEnum.PC_SAME_SIDE_ORDER_ALL_CANCELLED.getConstant()),

    PC_PREPARED_2_LIQ(EventEnum.PC_PREPARED_2_LIQ.getCode(), EventEnum.PC_PREPARED_2_LIQ.getConstant()),

    PC_MARGIN_CONSUMER_START(EventEnum.PC_MARGIN_CONSUMER_START.getCode(), EventEnum.PC_MARGIN_CONSUMER_START.getConstant()),
