...
//import com.hp.sh.expv3.bb.kline.service.BbKlineHistoryMergeFromExpService;
...
// */
//@Service
//public class BbKlineHistoryMergeFromExpServiceImpl2 implements BbKlineHistoryMergeFromExpService {
//
...
//                String triggerRedisKey = BbKlineRedisKeyUtil.buildKlineUpdateEventRedisKey(bbKlineFromExpTask, asset, symbol, triggerFreq);
////                String triggerRedisKey = buildKlineSaveRedisKey(asset, symbol, triggerFreq);
//                final Set<Tuple> triggers = bbKlineExpHistoryRedisUtil.zpopmin(triggerRedisKey, expHistoryBatchSize);
...
//        //向集合中插入元素，并设置分数
//        String key = BbKlineRedisKeyUtil.buildKlineUpdateEventRedisKey(bbKlineFromExpUpdate, asset, symbol, targetFreq);
//        bbKlineExpHistoryRedisUtil.zadd(key, new HashMap<String, Double>() {{
...
//        final String targetFreqRedisKey = BbKlineRedisKeyUtil.buildKlineDataRedisKey(bbKlineFromExpRepair, asset, symbol, targetFreq);
//        //删除老数据
//        bbKlineExpHistoryRedisUtil.zremrangeByScore(targetFreqRedisKey, newKline.getMs(), newKline.getMs());
//        //新增新数据
//        bbKlineExpHistoryRedisUtil.zadd(targetFreqRedisKey, new HashMap<String, Double>() {{
...
//        final String triggerFreqRedisKey = BbKlineRedisKeyUtil.buildKlineDataRedisKey(bbKlineFromExpRepair, asset, symbol, triggerFreq);
//        final Set<String> klines = bbKlineExpHistoryRedisUtil.zrangeByScore(triggerFreqRedisKey, startMs + "", endMs + "", 0, Long.valueOf(endMs - startMs + 1).intValue());
