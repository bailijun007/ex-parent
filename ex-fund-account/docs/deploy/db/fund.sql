...
`pay_finish_time`  bigint NULL DEFAULT NULL COMMENT '支付完成时间' ,
...
`created`  bigint NULL DEFAULT NULL COMMENT '创建时间' ,
`modified`  bigint NULL DEFAULT NULL COMMENT '修改时间' ,
PRIMARY KEY (`id`),
INDEX `idx_userid` (`user_id`) USING BTREE ,
