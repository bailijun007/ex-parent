...
public class PcPositonError extends ErrorCode {
	...
	public static final PcPositonError POS_NOT_ENOUGH = new PcPositonError(-13101, "超过了仓位!");
	public static final PcPositonError HAVE_ACTIVE_ORDER = new PcPositonError(-13102, "当前存在挂单，不能修改杠杆");
	public static final PcPositonError NO_MORE_MARGIN = new PcPositonError(-13103, "没有可减少的保证金");
