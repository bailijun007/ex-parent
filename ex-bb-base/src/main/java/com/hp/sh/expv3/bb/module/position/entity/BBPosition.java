package com.hp.sh.expv3.bb.module.position.entity;
 ...
 *
 */
@Table(name="bb_position")
public class BBPosition extends UserDataEntity {
...
//	private Integer closed;
	...
	public String toString() {
		return "BBPosition [id=" + id + ", userId=" + userId + ", asset=" + asset + ", symbol=" + symbol + ", longFlag="
