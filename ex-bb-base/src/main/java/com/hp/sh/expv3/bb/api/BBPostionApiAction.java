...
import com.hp.sh.expv3.bb.api.BBPostionApi;
...
@RestController
public class BBPostionApiAction implements BBPostionApi {
	
	@Autowired
	private BBPositionMarginService posMarginService;
	
	@Autowired
	private BBPositionDataService posDataService;
	
	@Autowired
	private BBAccountCoreService accountService;
	...
	public ChangeMarginVo showChangeMargin(Long userId, String asset, String symbol, Integer longFlag){
		BBPosition pos = this.posDataService.getCurrentPosition(userId, asset, symbol, longFlag);
	...
	public CurPositionVo getCurrentPosition(Long userId, String asset, String symbol, Integer longFlag){
		BBPosition pos = posDataService.getCurrentPosition(userId, asset, symbol, longFlag);
		if(pos==null){
			return null;
		}
