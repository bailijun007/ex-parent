 ...
 *
 */
public interface BBActivePositionDAO extends BaseMapper<BBActivePosition,Long> {

	public List<BBActivePosition> queryList(Map<String,Object> params);
	
	public BBActivePosition queryOne(Map<String,Object> params);
