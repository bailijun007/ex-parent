...
`short_leverage`  decimal(10,0) NOT NULL COMMENT '做空杠杆' ,
`long_leverage`  decimal(10,0) NOT NULL COMMENT '做多杠杆' ,
`long_max_leverage`  decimal(10,0) NOT NULL COMMENT '最大多仓杠杆' ,
`short_max_leverage`  decimal(10,0) NOT NULL COMMENT '最大多空杠杆' ,
...
`volume`  decimal(10,0) NOT NULL COMMENT '成交量（单位：张数）' ,
...
`face_value`  decimal(10,0) NOT NULL COMMENT '面值(单位：报价货币)' ,
