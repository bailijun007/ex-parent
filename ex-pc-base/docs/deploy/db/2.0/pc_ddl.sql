...
-- ----------------------------
DROP TABLE IF EXISTS `pc_active_order`;
...
PRIMARY KEY (`id`),
INDEX `idx_userid_symbol` (`user_id`, `asset`, `symbol`) USING BTREE 
)
ENGINE=InnoDB
DEFAULT CHARACTER SET=utf8mb4 COLLATE=utf8mb4_general_ci
...
-- ----------------------------
DROP TABLE IF EXISTS `pc_active_position`;
...
`long_flag`  int(11) NOT NULL COMMENT '多空' ,
PRIMARY KEY (`id`),
UNIQUE INDEX `idx_user_act_pos` (`user_id`, `asset`, `symbol`, `long_flag`) USING BTREE ,
...
-- ----------------------------
DROP TABLE IF EXISTS `pc_collector_account`;
...
-- ----------------------------
DROP TABLE IF EXISTS `pc_collector_account_record`;
...
`modified`  bigint(20) NULL DEFAULT NULL ,
PRIMARY KEY (`id`),
INDEX `idx_tk_account_id_tk_order_id` (`tk_account_id`, `tk_order_id`) USING BTREE ,
INDEX `idx_trade_time_symbol` (`trade_time`, `symbol`) USING BTREE 
)
ENGINE=InnoDB
DEFAULT CHARACTER SET=utf8mb4 COLLATE=utf8mb4_general_ci
